  ...
  (t.prototype.initCounter = function () {
    ...
    (t.prototype.initContact = function () {
      o("#contact-form").submit(function () {
        ...
        return (
          o("#message").slideUp(750, function () {
            o("#message").hide(),
              o("#submit").before("").attr("disabled", "disabled"),
              o.post(
                t,
                {
                  name: o("#name").val(),
                ...
                function (t) {
                  (document.getElementById("message").innerHTML = t),
                    o("#message").slideDown("slow"),
                    o("#cform img.contact-loader").fadeOut("slow", function () {
                      o(this).remove();
                    }),
                    o("#submit").removeAttr("disabled"),
                    null != t.match("success") && o("#cform").slideUp("slow");
                }
              );
          }),
          !1
